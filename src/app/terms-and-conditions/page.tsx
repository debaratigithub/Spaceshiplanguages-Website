...
import { TermsConditiondata } from "@/reduxts/Slices/cmsauthslice/termsNConditionSlice";

const TermsAndConditions = () => {
  const { data } = useAppSelector((state: RootState) => state.cmsTermsConData);
  // console.log(data, "+++++++++");

  const dispatch = useAppDispatch();
  useEffect(() => {
    dispatch(TermsConditiondata());
  }, [dispatch]);
